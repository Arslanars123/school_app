...
class UpdateParent extends StatefulWidget {
  ...
  @override
  State<UpdateParent> createState() => _UpdateStudentState();
}

class _UpdateStudentState extends State<UpdateParent> {
  ...
  Future<void> _updateStudent() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://170.249.216.178/~filterba/schooling/public/api/parents-update'),
      );
