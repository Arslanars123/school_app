...
class ParentLoginScreen extends StatefulWidget {
  ...
  @override
  State<ParentLoginScreen> createState() => _LoginOneScreenState();
}

class _LoginOneScreenState extends State<ParentLoginScreen> {
  ...
  Future<void> loginUser(String email, String password, String instituteId) async {
    ...
    // API endpoint
    var apiUrl = "http://170.249.216.178/~filterba/schooling/public/api/login-parent";
