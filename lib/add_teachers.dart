...
class AddTeacher extends StatefulWidget {
  ...
  @override
  State<AddTeacher> createState() => _UpdateStudentState();
}

class _UpdateStudentState extends State<AddTeacher> {
  ...
  Future<void> _updateStudent() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://170.249.216.178/~filterba/schooling/public/api/teachers-store'),
      );
