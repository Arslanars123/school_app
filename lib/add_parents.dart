...
class AddParents extends StatefulWidget {
  ...
  @override
  State<AddParents> createState() => _UpdateStudentState();
}

class _UpdateStudentState extends State<AddParents> {
  ...
  Future<void> _updateStudent() async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://170.249.216.178/~filterba/schooling/public/api/parents-store'),
      );
