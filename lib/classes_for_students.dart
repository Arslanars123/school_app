...
import 'package:school_app/students_of_slass.dart';
...
class _ClassesListScreenState extends State<ClassesForStudents> {
          ...
          children: [
            InkWell(
              onTap: () {
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          StudentOfClass(classId: id,data:apiResponse)),
                );
              },
              child: Container(
