...
class _StudentListScreenState extends State<ParentsListScreen> {
  ...
  Future<void> postData() async {
    ...
    // API endpoint
    String apiUrl =
        'http://170.249.216.178/~filterba/schooling/public/api/parents';
  ...
  Future<void> deleteStudents(String id) async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://170.249.216.178/~filterba/schooling/public/api/parents-delete'),
      );

      request.fields['parentId'] = id;
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(10),
                      child: Text('Add Parent',style: TextStyle(color: Colors.white,fontSize: 16),),
                    ),
                  ),
                ),
              ),
        ...
        child: Row(
          ...
          children: [
            CircleAvatarWithNetworkImage(
              imageUrl: apiData["picture"] != null ?"http://170.249.216.178/~filterba/schooling/public/"+apiData["picture"]:"", // Replace with your image URL
