...
class StudentOfClass extends StatefulWidget {
  final classId;
  final data;
  StudentOfClass({required this.classId,this.data});
  @override
...
class _StudentListScreenState extends State<StudentOfClass> {
  ...
  Future<void> postData() async {
    ...
    // API endpoint
    String apiUrl =
        'http://170.249.216.178/~filterba/schooling/public/api/students-of-class';
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({'schoolId': schoolId,"classId":widget.classId
        }),
      );
  ...
  Future<void> deleteStudents(String id) async {
    ...
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse('http://170.249.216.178/~filterba/schooling/public/api/students-delete'),
      );
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(10),
                      child: Text('Add Student',style: TextStyle(color: Colors.white,fontSize: 16),),
                    ),
                  ),
                ),
              ),
